"""add execution last_comment_id

Revision ID: fb31ea1918c1
Revises: 8cf002e831a0
Create Date: 2026-09-19 19:29:07.918258
...
revision: str = 'fb31ea1918c1'
down_revision: Union[str, Sequence[str], None] = '8cf002e831a0'
...
def upgrade() -> None:
    ...
    op.add_column('executions', sa.Column('last_comment_id', sa.Integer(), server_default='0', nullable=False))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('executions', 'last_comment_id')
